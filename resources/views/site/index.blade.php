			...
			<div class="row">
				<div class="col-md-6 col-lg-4 ftco-animate">
					<div class="project">
						...
						<a href="images/hotel-resto-1.jpg"
							class="icon image-popup d-flex justify-content-center align-items-center">
							<span class="icon-expand"></span>
						</a>
					</div>
				...
				<div class="col-md-6 col-lg-4 ftco-animate">
					<div class="project">
						...
						<a href="images/hotel-resto-2.jpg"
							class="icon image-popup d-flex justify-content-center align-items-center">
							<span class="icon-expand"></span>
						</a>
					</div>
				...
				<div class="col-md-6 col-lg-4 ftco-animate">
					<div class="project">
						...
						<a href="images/hotel-resto-3.jpg"
							class="icon image-popup d-flex justify-content-center align-items-center">
							<span class="icon-expand"></span>
						</a>
					</div>
		...
		<div class="container">
			<div class="row d-flex">
				...
				<div class="col-md-6 pr-md-5 py-5">
					...
					<div class="row">
						<div class="col-md-12">
							<p class="ftco-animate tips"><span>1.</span> A small river named Duden flows by their place
								and supplies it with the necessary regelialia.</p>
							<p class="ftco-animate tips"><span>2.</span> A small river named Duden flows by their place
